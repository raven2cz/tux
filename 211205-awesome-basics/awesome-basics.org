...
- [[#lua---programovací-jazyk][LUA - Programovací jazyk]]
  ...
  - [[#the-eight-queen-in-programming-in-lua-fourth-edition-8-královen-z-knihy-programování-lua-4vydání][The Eight-Queen in Programming in Lua Fourth Edition (8 královen z knihy programování Lua 4.vydání)]]
...
#+html: <p align="left"><img src="images/lua-info.jpg" /></p>

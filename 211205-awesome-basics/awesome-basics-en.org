...
+ I3 users love manual tiling and tab supports. Try experiments with dynamic tiling layouts first, next treetile and last machi-layout possbilities.
+ I3 users want quick and fast easy configuration - AW cannot directly provided it because it is framework. You can use some prepared demo projects.

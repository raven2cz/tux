...
- [[#změna-wallpapers-pro-jednotlivé-tagy][Změna wallpapers pro jednotlivé tagy]]
  - [[#random-wallpaper-for-1st-tag][random wallpaper for 1st tag]]
  - [[#different-wallpaper-per-actual-shown-tag][different wallpaper per actual shown tag]]
  - [[#user-wallpaper-tags][user wallpaper tags]]
  - [[#dev-tag-uses-as-default-colorscheme-wallpaper][dev tag uses as default colorscheme wallpaper]]
- [[#propojení-aplikací-do-awesomewm-prostředí][Propojení aplikací do awesomewm prostředí]]
  - [[#ukázka-s-tmux-a-nvim-propojení-s-awesomewm][ukázka s tmux a nvim propojení s awesomewm]]
  - [[#propjení-barevných-schémat-a-unifikace-gnulinux-aplikací-s-prostředím-awesomewm-a-jeho-model-view-schématem][propjení barevných schémat a unifikace GNU/Linux aplikací s prostředím awesomewm a jeho model-view schématem]]
  - [[#napojení-událostí-aplikací-s-naughty][napojení událostí aplikací s naughty]]
...
Toto část je popsána primárně ve video nahrávce...

* Základní ovládání
=super+ctrl+s=
#+html: <p align="left"><img src="images/awesome-multicolor-keybindings.jpg" /></p>

[TODO] Popis základních kláves a jejich organizace...
...
[TODO] Popis o co se jedná, jak změna probíhá.

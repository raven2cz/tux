...
* AwesomeWM Control Introduction [2022-02-18]
...
** Content :toc:
- [[#awesomewm-control-introduction-2022-02-18][AwesomeWM Control Introduction [2022-02-18]]]
  - [[#raven2czawesome-config-multicolor-theme][Raven2cz/awesome-config Multicolor Theme]]
  - [[#keybindings-help-superctrls][Keybindings Help [Super+Ctrl+s]]]
...
This video is fast introduction to customized awesome environment by project raven2cz/awesome-config - Multicolor Theme.

** Keybindings Help [Super+Ctrl+s]
...
** Colorscheme Changes
Support 15 colorschemes: eighties one dark, one dark, gruvbox dark soft, gruvbox light soft, darcula, dracula, nord, material, material palenight, tomorrow night, solarized dark, solarized light, doom one, monokai pro, oceanic next.
